#!/bin/bash
mkdir -p apps/web/app/\(app\)/accounting/chart-of-accounts
mkdir -p apps/web/app/\(app\)/accounting/journals
mkdir -p apps/web/app/\(app\)/accounting/analytic-accounts

# Accounts
cat << 'FILE' > apps/web/app/\(app\)/accounting/chart-of-accounts/page.tsx
"use client";
...
# Journals
cat << 'FILE' > apps/web/app/\(app\)/accounting/journals/page.tsx
"use client";
import { useEffect, useState } from "react";
import { Button } from "@/components/ui/button";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";
